...
-- CreateEnum
CREATE TYPE "CredentialProvider" AS ENUM ('PASSWORD', 'OAUTH', 'SAML', 'AZURE_AD');
...
-- CreateIndex
CREATE UNIQUE INDEX "credentials_provider_provider_user_id_key" ON "credentials"("provider", "provider_user_id");
